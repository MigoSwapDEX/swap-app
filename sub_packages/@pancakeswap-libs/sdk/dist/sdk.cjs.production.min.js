...
var e,
  ...
  f = require('@ethersproject/solidity'),
...
;((n = exports.ChainId || (exports.ChainId = {}))[(n.MAINNET = 1116)] = 'MAINNET'),
  (n[(n.BSCNET = 56)] = 'BSCNET'),
  (n[(n.BSCTESTNET = 97)] = 'BSCTESTNET'),
...
var v,
  y = '0x0dfba0285fbfd28525d64d85b90b38c9bb164c6b8f5db320c06e6ab59312d945',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
...
function W(t, e) {
  i.greaterThanOrEqual(t, T) || u(!1), i.lessThanOrEqual(t, E[e]) || u(!1)
}
function V(t) {
  try {
...
var $,
  z = function (t, e, n) {
    W(i.BigInt(t), v.uint8), (this.decimals = t), (this.symbol = e), (this.name = n)
  },
  G = (z.ETHER = new z(18, 'CORE', 'Core')),
  K = (function (t) {
...
function Z(t, e) {
  return t instanceof K && e instanceof K ? t.equals(e) : !(t instanceof K || e instanceof K || t !== e)
}
var tt,
  et,
  nt =
    ((($ = {})[exports.ChainId.MAINNET] = new K(
    ...
    ($[exports.ChainId.BSCTESTNET] = new K(
  ...
  at = (function () {
    function t(t, e) {
      void 0 === e && (e = g), (this.numerator = Y(t)), (this.denominator = Y(e))
    }
    var e = t.prototype
    return (
      (e.invert = function () {
  ...
  ct = (function (t) {
    function e(e, n) {
      var r,
        o = Y(n)
      return W(o, v.uint256), ((r = t.call(this, o, i.exponentiate(I, i.BigInt(e.decimals))) || this).currency = e), r
    }
    U(e, t),
      (e.ether = function (t) {
        return new e(G, t)
    ...
    return (
      ...
      (n.quote = function (e) {
        return (
          ...
          this.quoteCurrency instanceof K
  ...
  pt = (function () {
    ...
    t.getAddress = function (t, e) {
      ...
      return (
        void 0 ===
          (null === (n = lt) || void 0 === n || null === (r = n[s[0].address]) || void 0 === r
            ? void 0
            : r[s[1].address]) &&
          (lt = P(
            {},
            ...
            (((u = {})[s[0].address] = P(
              {},
              null === (o = lt) || void 0 === o ? void 0 : o[s[0].address],
              (((i = {})[s[1].address] = a.getCreate2Address(
                '0x91cE3Cf997CAD223654764b4338A92431997AFe9',
                f.keccak256(['bytes'], [f.pack(['address', 'address'], [s[0].address, s[1].address])]),
                y
              )),
              i)
            )),
    ...
    return (
      ...
      (e.getInputAmount = function (e) {
        ...
        var n = this.reserveOf(e.token),
          r = this.reserveOf(e.token.equals(this.token0) ? this.token1 : this.token0),
          o = i.multiply(i.multiply(r.raw, e.raw), q),
      ...
      (e.getLiquidityMinted = function (t, e, n) {
        ...
        if (((o[0].token.equals(this.token0) && o[1].token.equals(this.token1)) || u(!1), i.equal(t.raw, T)))
          r = i.subtract(J(i.multiply(o[0].raw, o[1].raw)), w)
        else {
      ...
      (e.getLiquidityValue = function (t, e, n, r, o) {
        ...
        if (
          ...
          if (i.equal(s, T)) a = e
            ...
            var c = J(i.multiply(this.reserve0.raw, this.reserve1.raw)),
              d = J(s)
            if (i.greaterThan(c, d)) {
              var f = i.multiply(e.raw, i.subtract(c, d)),
                l = i.add(i.multiply(c, A), d),
                p = i.divide(f, l)
              a = e.add(new dt(this.liquidityToken, p))
            } else a = e
          }
        } else a = e
  ...
  ht = (function () {
    function t(t, e, n) {
      t.length > 0 || u(!1),
        ...
        (e instanceof K && t[0].involvesToken(e)) || (e === G && t[0].involvesToken(nt[t[0].chainId])) || u(!1),
        void 0 === n ||
          (n instanceof K && t[t.length - 1].involvesToken(n)) ||
          (n === G && t[t.length - 1].involvesToken(nt[t[0].chainId])) ||
          u(!1)
      for (var r, o = [e instanceof K ? e : nt[t[0].chainId]], i = H(t.entries()); !(r = i()).done; ) {
        var a = r.value,
          s = a[1],
          c = o[a[0]]
...
function Tt(t, e) {
  return t instanceof dt ? t : t.currency === G ? new dt(nt[e], t.raw) : void u(!1)
}
function gt(t, e) {
  return t instanceof K ? t : t === G ? nt[e] : void u(!1)
}
var kt = (function () {
  function t(t, e, n) {
    var r,
    ...
    if (n === exports.TradeType.EXACT_INPUT) {
      ...
      for (var l = t.path.length - 1; l > 0; l--) {
        var p = t.pairs[l - 1].getInputAmount(a[l]),
          h = p[1]
        ;(a[l - 1] = p[0]), (s[l - 1] = h)
      }
    }
    ;(this.route = t),
      (this.tradeType = n),
      (this.inputAmount = n === exports.TradeType.EXACT_INPUT ? e : t.input === G ? ct.ether(a[0].raw) : a[0]),
      (this.outputAmount =
        n === exports.TradeType.EXACT_OUTPUT ? e : t.output === G ? ct.ether(a[a.length - 1].raw) : a[a.length - 1]),
      ...
      (this.nextMidPrice = ft.fromRoute(new ht(s, t.input))),
      (this.priceImpact =
        ((r = this.outputAmount),
  ...
  return (
    ...
    (t.bestTradeExactIn = function (e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        p > 0 || u(!1),
        a === n || i.length > 0 || u(!1)
      var h = n instanceof dt ? n.token.chainId : r instanceof K ? r.chainId : void 0
      void 0 === h && u(!1)
      for (var m = Tt(n, h), v = gt(r, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            Q(s, new t(new ht([].concat(i, [w]), a.currency, r), a, exports.TradeType.EXACT_INPUT), f, wt)
          else if (p > 1 && e.length > 1) {
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactIn(k, g, r, { maxNumResults: f, maxHops: p - 1 }, [].concat(i, [w]), a, s)
          }
        }
      }
      return s
    ...
    (t.bestTradeExactOut = function (e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        p > 0 || u(!1),
        a === r || i.length > 0 || u(!1)
      var h = r instanceof dt ? r.token.chainId : n instanceof K ? n.chainId : void 0
      void 0 === h && u(!1)
      for (var m = Tt(r, h), v = gt(n, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            Q(s, new t(new ht([w].concat(i), n, a.currency), a, exports.TradeType.EXACT_OUTPUT), f, wt)
          else if (p > 1 && e.length > 1) {
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactOut(k, n, g, { maxNumResults: f, maxHops: p - 1 }, [w].concat(i), a, s)
          }
        }
      }
      return s
...
var At,
  It = (function () {
    ...
    return (
      (t.swapCallParameters = function (t, e) {
        var n = t.inputAmount.currency === G,
          r = t.outputAmount.currency === G
        n && r && u(!1), e.ttl > 0 || u(!1)
        var o,
          i,
          a,
          ...
          l = '0x' + (Math.floor(new Date().getTime() / 1e3) + e.ttl).toString(16),
          p = Boolean(e.feeOnTransfer)
        switch (t.tradeType) {
          case exports.TradeType.EXACT_INPUT:
            n
              ? ((o = p ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'),
                (i = [d, f, s, l]),
                (a = c))
              : r
              ? ((o = p ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'),
                (i = [c, d, f, s, l]),
                (a = '0x0'))
              : ((o = p ? 'swapExactTokensForTokensSupportingFeeOnTransferTokens' : 'swapExactTokensForTokens'),
                (i = [c, d, f, s, l]),
                (a = '0x0'))
            break
          case exports.TradeType.EXACT_OUTPUT:
            p && u(!1),
              n
                ? ((o = 'swapETHForExactTokens'), (i = [d, f, s, l]), (a = c))
                : r
                ? ((o = 'swapTokensForExactETH'), (i = [d, c, f, s, l]), (a = '0x0'))
                : ((o = 'swapTokensForExactTokens'), (i = [d, c, f, s, l]), (a = '0x0'))
        }
  ...
  Ot = (((At = {})[exports.ChainId.MAINNET] = { '0xA62d2fD3A96363976188b011eBF47d2e1232959A': 9 }), At),
  qt = (function () {
    function t() {}
    return (
      (t.fetchTokenData = function (t, e, n, r, o) {
        try {
          var i,
            u,
            a = function (n) {
              return new K(t, e, n, r, o)
            }
          void 0 === n && (n = h.getDefaultProvider(p.getNetwork(t)))
          var s =
            'number' ==
          ...
          return Promise.resolve(
            s
              ? a(Ot[t][e])
              : Promise.resolve(
                  new l.Contract(e, bt, n).decimals().then(function (n) {
                    var r, o, i
                    return (
                      (Ot = P(
                        {},
      ...
      (t.fetchPairData = function (t, e, n) {
        try {
          void 0 === n && (n = h.getDefaultProvider(p.getNetwork(t.chainId))), t.chainId !== e.chainId && u(!1)
          var r = pt.getAddress(t, e)
          return Promise.resolve(new l.Contract(r, m.abi, n).getReserves()).then(function (n) {
            var r = n[0],
              o = n[1],
              i = t.sortsBefore(e) ? [r, o] : [o, r]
            return new pt(new dt(t, i[0]), new dt(e, i[1]))
          })
        } catch (t) {
          return Promise.reject(t)
        }
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = G),
  (exports.FACTORY_ADDRESS = '0x91cE3Cf997CAD223654764b4338A92431997AFe9'),
  (exports.Fetcher = qt),
  (exports.Fraction = at),
